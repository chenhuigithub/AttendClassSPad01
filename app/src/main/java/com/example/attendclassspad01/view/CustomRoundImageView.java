package com.example.attendclassspad01.view;
 ...
 *
 * @author zhaochenhui, 博客原作者Alan, 2016.11.01
 */
public class CustomRoundImageView extends AppCompatImageView {
    ...
    private void setCustomAttributes(AttributeSet attrs) {
        ...
        // mBorderOutsideColor =
        // a.getColor(R.styleable.CircleImageView_border_color, defaultColor);
        mBorderInsideColor = a.getColor(
                R.styleable.RoundImageView_border_color, defaultColor);
        a.recycle();
    }
